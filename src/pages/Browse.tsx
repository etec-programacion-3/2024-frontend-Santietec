      ...
      <div className="relative h-72 mb-8">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black via-black/50 to-transparent">
          <div className="absolute bottom-16 left-4 md:left-16 max-w-xl">
            <h1 className="text-4xl md:text-6xl font-bold mb-4">Título destacado</h1>
            <p className="text-lg mb-4">
              Una descripción breve de la película o serie destacada que captura la atención del
              espectador.
            </p>
            <div className="flex space-x-4">
              <button
                className="flex items-center bg-white text-black px-6 py-2 rounded font-semibold hover:bg-white/90"
                onClick={() => handlePlayMovie(trendingMovies[0])}
              >
